...
0. Challenges
   ...
   - [Interacting with PublicAPI1](https://github.com/lalamove/intern-tech-challenge)
   - [Interacting with PublicAPI2](https://github.com/golang-assessments/infra-challenge)
   - [Write a Kubernetes Operator](https://github.com/form3tech-oss/kubernetes-interview/tree/add-interview-guide)
   - [Write a Kubernetes Controller](https://x.com/odirionyeo/status/1671216700782436353)
   - [SRE Instrumentation Challenge](https://github.com/axpogroup/hiring-challenges/tree/main/sre-instrumentation-challenge)
